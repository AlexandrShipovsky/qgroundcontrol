/** @file
 *	@brief MAVLink comm testsuite protocol generated from air-link.xml
...
TEST(air-link, AIRLINK_AUTH)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::air-link::msg::AIRLINK_AUTH packet_in{};
    ...
    mavlink::air-link::msg::AIRLINK_AUTH packet1{};
    mavlink::air-link::msg::AIRLINK_AUTH packet2{};
...
#ifdef TEST_INTEROP
TEST(air-link_interop, AIRLINK_AUTH)
{
